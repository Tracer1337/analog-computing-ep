...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption{Auswirkungen einer nicht-negativen Aktivierungsfunktion auf das \ac{c-ep}. Quelle: \textit{Eigene Darstellung}}
