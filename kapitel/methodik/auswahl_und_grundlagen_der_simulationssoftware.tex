...
Wie mithilfe der genannten Blöcke das Masse-Pfeder-Dämpfer System aus Abbildung \ref{fig:Feder-Masse-D\"ampfer System mit R\"uckkopplung} modelliert werden kann, wurde bereits von \citeauthor{Ulmann2022} gezeigt, siehe Abbildung \ref{fig:Masse-Feder-Dämpfer Simulink}.
...
\begin{figure}[h]
  ...
  \\
  Quelle: \cite{website:mathworks:simscape}
